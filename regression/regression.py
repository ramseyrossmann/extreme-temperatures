...
# else:# P['scope'] == 'wi':
#     fips = fipswi
#     temp_filename = 'temp_counties_wi_3d.npy'
#     load_filename = 'load_counties_wi_2011.csv'
...
nload = dir1+'spatial_load_23years.npy'
D_data = {True:{e:{'temp':dir1+t_prefix + e + suffix,'load':dir1+l_prefix + e + suffix} for e in efiles},
